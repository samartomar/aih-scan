...
repository that builds the `@aihq/scan@0.1.4` V2 package and `aih-scan`
...
evidence custody. Source `0.1.4` is an unpublished patch candidate for the
per-command help and Core qualification-digest handoff fixes. The Core lock is
a post-`0.1.1` compatibility fixture whose
