      ...
      : analyzer === "skillspector"
        ? sarif(
            ...
            [
              ...
              {
                ruleId: "AS2",
                message: { text: "source-relative path in another component" },
                locations: [location("skills/other/SKILL.md", { startLine: 1 })],
              },
            ],
            [
              {
          ...
          ? sarif(analyzer, [
              {
                ...
                locations: [location("skills/demo/SKILL.md", { startLine: 3, startColumn: 5 })],
              },
            ])
          : sarif(analyzer, []);
    return {
      ...
      bytes,
      analyzerVersion: batchAnalyzerVersion(analyzer, `${analyzer}.0123456789ab`),
      executionProfileId: BASELINE_BATCH_EXECUTION_PROFILES_V1[analyzer],
    };
  };
